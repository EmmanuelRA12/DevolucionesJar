package com.eglobal.ti.devoluciones.jar.exceptions.handle;
...
import com.eglobal.ti.devoluciones.jar.dto.RespDTO;
...
public class ResponseRestApi<T> implements Serializable {
	...
	public ResponseRestApi(HttpStatus httpStatus, String message, String detailMessage, List<RespDTO> dataList) {
		this.httpStatus = httpStatus;
	...
	public ResponseRestApi(List<RespDTO> dataList) {
		this.dataList = dataList;
	}
	...
	public List<RespDTO> getDataList() {
		return dataList;
	}

	public void setDataList(List<RespDTO> dataList) {
		this.dataList = dataList;
	}
